...
<div class="x_panel">
    ...
    <div class="x_content">
        ...
        <button type="button" class="btn btn-primary pull-right addGeneric" data-toggle="modal" data-target=".add-modal">Add Project</button>
            ...
            <tbody>
                @foreach ($projects as $key => $project)
                    <tr>
                        ...
                        <td>{{$project->date}}</td>
                        <td width="30px"><img  style="width:100% !important" src="{{asset('images/'.$project->image)}}" alt=""></td>
                        <td>
                            <div class="form-group" style="display:inline-flex">
                                    ...
                                    <form class="form-horizontal" method="get" action="{{ url('project/destroy/'. $project->id)}}">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
                <form method="POST" id="modal-form" action="{{ url('project/save') }}" enctype="multipart/form-data"  data-parsley-validate class="form-horizontal form-label-left">
                    @csrf
                          ...
                          <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="date" id="date" name="date" required="required" class="form-control col-md-7 col-xs-12" maxlength="60">
                                </div>
                          </div>
                          <div class="form-group ">
